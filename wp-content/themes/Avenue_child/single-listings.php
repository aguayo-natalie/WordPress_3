...
<div class="propsmeta clearfix">
	...
	<div class="propslist"><span>Dormitorios - </span> <span class="propval"> <?php echo get_the_term_list( $post->ID, 'bedrooms', '', ' ', '' ); ?></span></div>
	...
	<div class="propslist">
		...
		<span class="propval"> <?php echo get_post_meta($post->ID, 'metros_cuadrados', true);?></span>
	</div>

	<?php
		$brochure = get_post_meta($post->ID, 'file', true);
	?>	

	<?php if ($brochure) { ?>
	<div class="propslist">
		<span>Brochure - </span>
		<a href="<?php echo $brochure; ?>" class="propval">brochure</a>
	</div>	
	<?php } ?>
</div>
